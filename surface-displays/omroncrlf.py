...
Driver for the OMRON strain display, for communication via the CRLF protocol.
...
__author__ = "Nicholas Rathmann"
__email__ = "rathmann@nbi.ku.dk"
...
slaveaddress = 0x00  # this is the address of the unit.

REDIS_HOST = "localhost"
idstr = "omroncrlf" # ID string for printing
